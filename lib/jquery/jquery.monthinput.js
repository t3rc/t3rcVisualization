...
//}}}
	...
	function Monthinput(input, conf)  { 
		...
		if (!labels) { throw "Monthinput: invalid language: " + conf.lang; }
...
//{{{  setValue
	...
	$.expr[':'].date = function(el) {
		...
		return type && type == 'date' || !!$(el).data("monthinput");
	};
	
	
	$.fn.monthinput = function(conf) {   
		
		// already instantiated
		if (this.data("monthinput")) { return this; } 
		...
		this.each(function() {									
			var el = new Monthinput($(this), conf);
			instances.push(el);
			var input = el.getInput().data("monthinput", el);
