                ...
                for(var b=0; b < _object.dates[v].category.length; b++)
                {
                    if (_object.dates[v].category[b].name == "application")
                    {
                        ...
                        for (var k=0; k< _object.dates[v].category[b]._event.length; k++ )
                        {
                            ...
                            //hs += "<b>"+_object.dates[v].category[b]._event[k].app_name+"</b>";
                            //hs += "<br>";
                            //hs += "<i>"+_object.dates[v].category[b]._event[k].dateEvent+"</i>";
                            //hs += "<br>";
                            //hs += "Duration in seconds:"+_object.dates[v].category[b]._event[k].duration;
                            //hs += "<br>";
                            //hs += "<br>";
