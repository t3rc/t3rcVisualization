$(document).ready(function(){
	...
	//Player Speed
	$("#slider").slider({range:"min", value:500, min:100, max:1000, slide:function(event,ui){speed = ui.value;console.debug(speed);$( "#amount" ).val( "Player speed is: " + speed/1000.0 + " s")}});
	$("#amount").val("Player speed is: " + speed/1000.0 + " s");
	initializeMashUpMap();
	initializeTimeplot();
